    ...
    <section className="relative py-14">
      <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
        <div className="max-w-2xl sm:text-center md:mx-auto">
          <h3 className="text-red-800 text-xl font-semibold">Testimonials</h3>
          <h3 className="text-gray-800 text-3xl font-semibold sm:text-4xl">
            Hear from our Students
          </h3>
          <p className="mt-3 text-gray-600">
            Read about the experiences of students who have benefited from our
            tutoring services.
          </p>
        </div>
        <div className="mt-12">
          <ul className={`grid items-center gap-6 ${testimonials.length == 0 ? 'grid' : 'sm:grid-cols-2 lg:grid-cols-3' }`}>
            {testimonials.length > 0 ? (
              ...
              <div
                ...
                className=" w-full md:p-20 p-6 sm:p-10 shadow-sm bg-white border border-gray-200 rounded-lg   dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
              >
                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white text-center">
                  No testimonials found
                </h5>
                <p className="font-normal text-gray-700 dark:text-gray-400 text-center">
                 Please add testimonials to see them here.
                </p>
              </div>
            )}
          </ul>
