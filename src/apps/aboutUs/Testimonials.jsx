      ...
      <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
        <div className="max-w-2xl sm:text-center md:mx-auto">
          ...
          <p className="mt-3 text-gray-600">
            Read about the experiences of students who have benefited from our tutoring services.
          </p>
        </div>
        <div className="mt-12">
                ...
                <li key={idx} className="bg-white rounded-xl border shadow-md">
                  ...
                  <figure>
                    ...
                    <div className="flex items-center gap-x-4 p-4 mt-6 bg-indigo-50">
                      <img src={item.image_url} className="w-16 h-16 rounded-full border-2 border-indigo-500" alt={item.name} />
                      <div>
                        <span className="block text-gray-800 font-semibold">{item.name}</span>
                        <span className="block text-indigo-600 text-sm mt-0.5">{item.Designation}</span>
                      </div>
                    </div>
                  </figure>
                </li>
