...
const Hero = () => {
  return (
    <div>
        <div className="flex flex-col justify-start gap-6 my-7">
            ...
            <div className='flex gap-5 mt-10'>
                <PrimaryButton className='px-6 py-3 text-lg font-semibold tracking-wider rounded-md outline outline-2 outline-red-800 outline-offset-2' label='Enroll Now'/>
                <SecondaryButton className='px-6 py-3 text-lg font-semibold tracking-wider text-black bg-white rounded-md outline outline-2 outline-red-800 outline-offset-2' label='Contact Us'/>
            </div>
