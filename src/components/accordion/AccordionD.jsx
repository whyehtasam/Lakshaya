...
function AccordionD() {
  return (
    <>
    <h1 className='text-center text-5xl pt-12 font-[700] text-[#a21a4c] uppercase'>Important information about lost</h1>
    <Accordion className='p-5 max-w-[80%] m-auto mt-5 mb-5'>
      <Accordion.Panel>
        ...
        <Accordion.Content>
          ...
          <p className="text-gray-500 dark:text-gray-400 text-[#a21a4c] font-[500]">
      ...
      <Accordion.Panel>
        ...
        <Accordion.Content>
          <p className="mb-2 text-gray-500 dark:text-gray-400 text-[#a21a4c] font-[500]">
      ...
      <Accordion.Panel>
        ...
        <Accordion.Content>
          ...
          <p className="mb-2 text-gray-500 dark:text-gray-400 text-[#a21a4c] font-[500]">Learn more about these technologies: </p>
